...
const PDFSheetViewer = (function () {
  ...
  async function _downloadPDF() {
    ...
    var pdfFileName = (_currentCharName || 'character').replace(/[^a-zA-Z0-9_\- ]/g, '') + '_sheet.pdf';
    var statusId = typeof TransferStatus !== 'undefined' ? TransferStatus.show('download', pdfFileName) : null;
    ...
    try {
      ...
      if (statusId) TransferStatus.hide(statusId);
